...
public class FavoritesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            savedPlaceList.addAll(db.savedPlaceDAO().loadAllById(mAuth.getCurrentUser().getUid()));
            ...
            runOnUiThread(() -> {
                ...
                lvFavorites.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                        ...
                        cidadeSelecionada = cidadeSelecionada.substring(0, cidadeSelecionada.indexOf(","));
